  ...
  implements Atom
{
   ...
   * @param dimensions
   *          the dimensions. If this variable is a multi-dimensional array, the list of values will be mapped according
   *          to these dimensions.
   */
  ...
  /**
   * Marks the variable as persistent in a machines context, i.e. it "belongs" to that machine.
   * 
   * @param persistent
   *          is it persistent
   */
