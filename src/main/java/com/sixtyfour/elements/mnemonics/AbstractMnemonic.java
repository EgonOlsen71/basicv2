  ...
  implements Mnemonic
{
  ...
  /**
   * Creates a new instance for a mnemonic of the given name. The list of opcodes has to have a length of 12 and has to
   * contain opcodes for all the possible addressing modes that the mnemonic can use. Those that it can't use have to be
   * 0.
   * 
   * @param name
   *          the name
