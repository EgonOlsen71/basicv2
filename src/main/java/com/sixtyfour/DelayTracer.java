...
/**
 * A Tracer implementation that can be used to delay the execution of BASIC commands.
 * 
 * @author EgonOlsen
 *
 */
  ...
  implements Tracer
{
  ...
  /**
   * Creates a new DelayTracer. This implementation tries to calculate the delay time to achieve the desired
   * commands/second rate based on the average execution time.
   * 
