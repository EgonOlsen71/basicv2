...
/**
 * The Basic is the basic class for parsing/compiling and executing BASIC V2
 * programs.
 * 
 * @author EgonOlsen
 * 
...
public class Basic implements ProgramExecutor {
	...
	/**
	 * Comnpiles the code. This can be called before calling the actual run
	 ...
	 * want to re-run the same program multiple times without compiling it over
	 * and over again.
	 */
	public void start() {
		stop = false;
