...
public class Machine
{
  ...
  /**
   * The same as add, this in addition, it will set the value of the new variable to the old one, if it finds it.
   * 
   * @param var
   *          the variable
   * @return either the newly added variable or the old one with the same name
  ...
  /**
   * Returns the command list. This list contains all the commands of the BASIC program in order or parsing.
   * 
