...
public class ProgramPart
{
  ...
  /**
   * Returns the actual bytes of this part. As usual, this is returned as an array of int[] but actually contains bytes.
   * 
   * @return the bytes
   */
  public int[] getBytes()
  ...
  /**
   * Sets the bytes of this part. As usual, this is set as an array of int[] but actually has to contain bytes.
   * 
   * @param bytes
   */
  ...
  /**
   * Returns the addresses on which the actual opcodes start. This isn't needed for execution but for debugging output
   * only.
   * 
