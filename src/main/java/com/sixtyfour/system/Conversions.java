...
/**
 * Converts back and forth between Java floats and the actual memory representation, that the C64 uses.
 * 
 * 
 * @author EgonOlsen
 *
...
{
  /**
   * Compacts a C64 float from extended 6 byte representation to condensed 5 byte representation.
   * 
