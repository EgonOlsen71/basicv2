...
public class AssemblyParser
{
  ...
  /**
   * Returns the value of an expression in the code. If the expression can't be evaluated to a number, an exception will
   * occur. If the number is actually a label that hasn't been defined yet, the current address will be returned instead
   * and an information will be added to the LabelsContainer that indicates that additional work has to be done once the
   * label is known later in the parsing process.
   * 
   * @param number
   *          the number
   * @param addr
