...
/**
 * A Term is a (part of a) calculation or a logical operation. Terms have two children (left and right) and an operator
  ...
  implements Atom
{
  ...
  /**
   * Instantiates a new term with an Atom as left child and a 0 as the right child. The operator is a NOP.
   * 
   * @param left
   *          the left child
   */
  ...
  /**
   * Checks if the Term is complete. A complete term has two children and an operator.
   * 
  ...
  /**
   * Returns the key. The key is used for internal replacement of parts of a term (as text) by placeholders.
   * 
   * @return the key
   */
  ...
  /**
   * Sets the key. The key is used for internal replacement of parts of a term (as text) by placeholders.
   * 
   * @param key
   *          the new key
   */
  ...
  /**
   * If this term has been compiled by the JIT compiler, this will return the Method instance in the compiled code.
   * 
  ...
  /**
   * Sets the initial term after evaluating the potential replacements in the term map
   * 
   * @param initial
   *          the initial term
   * @param termMap
  ...
  /**
   * Sets the Method instance, once this term has been compiled by the JIT compiler
   * 
   * @param jitted
   *          the method
   */
