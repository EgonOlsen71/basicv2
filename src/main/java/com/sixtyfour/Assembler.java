...
/**
 * Assembler is for parsing/compiling and executing 6502 assembler programs. The program will be compiled into actual
 * 6502 binary code. When running it, it will be copied into the machines 64kb of memory and executed from there by
  ...
  implements ProgramExecutor
{
  ...
  /**
   * Instantiates a new compiler for an assembler program. No interpretation/compilation will take place at this stage.
   * 
   * @param code
   *          the assembler code
   */
  ...
  /**
   * Instantiates a new compiler for an assembler program. No interpretation/compilation will take place at this stage.
   * This constructor takes an array of code lines as input. Each code line should represent a line in the assembler
   * program.
   * 
   * @param code
   *          the assembler code
   ...
   * to though, because run() will call it on its own if needed. After compilation, the compiled program can be obtained
   * via getProgram(); The compiled Program instance has a starting address set that is based on the first block of
   * actual opcodes in the assembler listing. If this assumption isn't true for a particular program, you have to set
   * the value manually before executing the actual program.
   */
  @Override
  public void compile()
  {
  ...
  /**
   * Runs the program. This will also compile it if needed (i.e. if it hasn't been done before), unpause and reset the
   * cpu and execute the program in a 6502 emulation.
   */
  @Override
  public void run()
  {
  ...
  /**
   * Similar to run(), but the program won't be compiled automatically and the cpu won't be reset.
   */
  @Override
  public void start()
  {
  ...
  /**
   * Gets the machine's cpu. This cpu is used to execute machine language code. It's a 6502 emulation. If you want to
   * add tracing or get more options/details, this is the place to go.
   * 
   * @return
   */
  @Override
  ...
  /**
   * Gets the compiled program. If compile() hasn't been called yet, null will be returned.
   * 
  ...
  /**
   * Sets a new program. Actually, there's no need to call this method in normal code.
   * 
   * @param program
   *          the new program
   */
  ...
  /**
   * Dumps the compiled program into a kind of monitor view. If the program hasn't been compiled yet, null will be
   * returned.
   */
