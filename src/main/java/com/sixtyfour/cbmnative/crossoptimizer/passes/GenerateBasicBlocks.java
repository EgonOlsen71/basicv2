 ...
 *
 * The main benefit is that if you have a line with many commands and there is
 * no loop in them, a constant propagator would be safe to apply.
 *
 * Code transforms from: 10 PRINT "A" 20 GOTO 50 50 ....
 *
 * 150 GOTO 10
 *
 * To:
 *
 * 10 PRINT "A": GOTO 50 50 ... 150 GOTO 10
 *
 */
