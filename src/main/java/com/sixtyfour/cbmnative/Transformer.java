...
public interface Transformer {
     ...
     */
    List<String> transform(Machine machine, PlatformProvider platform, List<String> code);

    /**
     * Can be implemented to add some additional code that handles the actual
     * calling of the compiled code. This is used for the Javascript target to
     * wrap the result into something that can run in a browser.
     * 
     * @param calleeName
     *            what to call
    ...
    /**
     * Sets the memory address on which the variables start (if applicable).
     * Default is -1.
     * 
     * @param variableStart
     *            the variable start
    ...
    /**
     * Returns the memory address on which the string memory ends (if
     * applicable).
     * 
    ...
    /**
     * Returns the memory address on which the runtime code starts (if
     * applicable).
     * 
