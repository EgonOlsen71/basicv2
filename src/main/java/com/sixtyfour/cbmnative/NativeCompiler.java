...
public class NativeCompiler {
    ...
    /**
     * Compiles a BASIC program into native (or assembly) code of the given
     * target platform. Memory and compiler configuration are defaults.
     * 
     * @param basic
    ...
    /**
     * Returns the last processed line. If something went wrong, this is most
     * likely the line that caused it.
     * 
