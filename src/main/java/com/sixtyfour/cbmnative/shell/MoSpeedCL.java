...
public class MoSpeedCL {
	...
	System.out.println("/symboltable=<file> - this only applies to the X16 target platform. It lets you specify a different symbol table to compile for different ROM releases. The default symbol table should match the latest ROM release.");
	System.out.println();
    }
