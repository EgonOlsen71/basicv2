...
public class Optimizer64 implements Optimizer {
	...
	{
	    this.add(new Pattern("Simplified setting to 0", new String[] { "LDA #0", "STA {MEM0}" }, "LDA #<{#0.0}",
		    "LDY #>{#0.0}", "JSR REALFAC", "LDX #<{MEM0}", "LDY #>{MEM0}", "JSR FACMEM"));
	    ...
	    this.add(new Pattern("REG0->VAR, REG0->REG1", new String[] { "{LINE6}", "{LINE7}", "{LINE8}" },
		    ...
		    "LDX #<{MEM0}", "LDY #>{MEM0}", "JSR FACMEM", "LDA #<{REG0}", "LDY #>{REG0}", "JSR REALFAC",
		    "LDX #<{REG1}", "LDY #>{REG1}", "JSR FACMEM", "LDA #<{REG1}", "LDY #>{REG1}", "JSR REALFAC"));
	    this.add(new Pattern("FAC into REG?, REG? into FAC, REG into...",
		    new String[] { "{LINE0}", "{LINE1}", "{LINE2}", "{LINE6}", "{LINE7}", "{LINE8}", "{LINE9}",
			    "{LINE10}", "{LINE11}" },
		    "LDX #<{REG0}", "LDY #>{REG0}", "JSR FACMEM", "LDA #<{REG0}", "LDY #>{REG0}", "JSR REALFAC",
		    "LDX #<{MEM0}", "LDY #>{MEM0}", "JSR FACMEM", "LDA #<{REG0}", "LDY #>{REG0}", "JSR REALFAC"));
	    ...
	    // it...
	    this.add(new Pattern(false, "POKE with integer constant(1)@real location",
		    new String[] { "JSR REALFAC", "JSR FACWORD", "STY 105", "STA 106", "LDA {MEM0}", "LDY #0",
			    "STA (105),Y" },
		    "JSR REALFAC", "JSR PUSHREAL", "LDY {MEM0}", "LDA {MEM0}", "JSR INTFAC", "LDX #<{REG0}",
		    "LDY #>{REG0}", "JSR FACMEM", "JSR POPREAL", "JSR FACWORD", "STY 105", "STA 106", "LDA #<{REG0}",
		    "LDY #>{REG0}", "JSR REALFAC", "JSR FACWORD", "TYA", "LDY #0", "STA (105),Y"));
