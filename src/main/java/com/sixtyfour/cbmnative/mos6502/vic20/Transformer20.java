 ...
 * 
 */
public class Transformer20 implements Transformer {

	private int variableStart = -1;
	private int runtimeStart = -1;
	private int stringMemoryEnd = 0x3fff; // will be adjusted in the runtime
	private int startAddress = 4120;
	...
	public List<String> transform(Machine machine, PlatformProvider platform, List<String> code) {
		...
		subs.addAll(Arrays.asList(Loader.loadProgram(this.getClass().getResourceAsStream("/subroutines20.asm"))));
