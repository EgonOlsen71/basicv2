...
/**
 * Interface to enhance the actual BASIC code programmatically by a first and a last command, which will be executed
 * before and after the actual program's code.
 * 
 * @author EgonOlsen
 *
 */
