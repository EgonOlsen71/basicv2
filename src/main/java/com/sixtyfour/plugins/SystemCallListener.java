...
/**
 * A listener for calls of the SYS/USR command.
 */
public interface SystemCallListener {
	 ...
	 * 
	 * @param params
	 *            an optional parameter, which has to be evaluated by the
	 *            machine program (which is difficult in this environment...)
