...
; Optimizer rule: Faster array access setup(3)/11
; Optimizer rule: POP and XREG combined/1
; Optimizer rule: FAC 2 X_REG(2)/1
LDA #<VAR_S$[]
LDY #>VAR_S$[]
...
; *** CONSTANTS ***
CONSTANTS
; CONST: ${clear}{down}ausfuehrung: 1{left}
CONST_0	.BYTE 33
.STRG "{clear}{down}ausfuehrung: 1{left}"
; CONST: #1000

CONST_1R	.REAL 1000.0
; CONST: $2{left}
CONST_2	.BYTE 7
.STRG "2{left}"
; CONST: #0
...
CONST_17R	.REAL 2.0
; CONST: ${clear}{down*3}b1:
CONST_18	.BYTE 18
.STRG "{clear}{down*3}b1:"
; CONST: #60
