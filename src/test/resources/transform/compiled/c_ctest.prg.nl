...
MOVBSELF5:
STY $FFFF
; Optimizer rule: Faster PEEKBYTEADDAND2/8
LDA #0
STA A_REG
STA A_REG+1
JSR NEXT
...
CONST_2R	.REAL 1024.0
; CONST: #2023

CONST_3R	.REAL 2023.0
; CONST: #1.0
...
CONST_9	.BYTE 12
.STRG "waehle test:"
; CONST: $ 1. 256 tests m/ variablen (schnell 256)
CONST_10	.BYTE 40
.STRG " 1. 256 tests m/ variablen (schnell 256)"
; CONST: $ 2. 128 tests m/ variablen (schnell 128)
CONST_11	.BYTE 40
.STRG " 2. 128 tests m/ variablen (schnell 128)"
; CONST: $ 3. 256 tests m/ konstant
CONST_12	.BYTE 25
.STRG " 3. 256 tests m/ konstant"
; CONST: $ 4. 128 tests m/ konstant
CONST_13	.BYTE 25
.STRG " 4. 128 tests m/ konstant"
; CONST: #198

CONST_14R	.REAL 198.0
; CONST: #4

CONST_15R	.REAL 4.0
; CONST: $ungültig. bitte nochmal
CONST_16	.BYTE 23
.STRG "ungültig. bitte nochmal"
; CONST: $compiler test (
CONST_17	.BYTE 15
.STRG "compiler test ("
; CONST: $):
