...
LINE_65:
;
JMP ENDDEF2775a63846b6232662fff87128061bbd
DEF2775a63846b6232662fff87128061bbd:
JSR POPREALXREG
...
JSR PUSHREAL
RTS
ENDDEF2775a63846b6232662fff87128061bbd:
;
LINE_70:
;
JMP ENDDEF83f56f37a245ccaf8c885814074777f6
DEF83f56f37a245ccaf8c885814074777f6:
JSR POPREALXREG
; Optimizer rule: POP and XREG combined/1
; Optimizer rule: FAC 2 X_REG(2)/1
; Optimizer rule: POP, REG0, VAR0/4
...
JSR REALFACPUSH
; Optimizer rule: Load and PUSH combined/1
JSR DEF2775a63846b6232662fff87128061bbd
LDA #<VAR__X_TE
LDY #>VAR__X_TE
JSR COPY2_XYA_XREG
; Optimizer rule: MEM 2 X_REG/3
...
JSR PUSHREAL
RTS
ENDDEF83f56f37a245ccaf8c885814074777f6:
;
LINE_80:
;
LDA #<CONST_11R
...
JSR REALFACPUSH
; Optimizer rule: Load and PUSH combined/1
JSR DEF83f56f37a245ccaf8c885814074777f6
JSR POPREALXREG
; Optimizer rule: POP and XREG combined/1
; Optimizer rule: FAC 2 X_REG(2)/1
; Optimizer rule: POP, REG0, VAR0/4
