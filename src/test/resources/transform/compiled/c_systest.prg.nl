...
LDA #<VAR_XP
LDY #>VAR_XP
JSR COPY2_XREG_REALPAR
; Optimizer rule: Combine copy and real par/1
LDA #<VAR_Y
LDY #>VAR_Y
JSR COPY2_XREG_REALPAR
; Optimizer rule: Combine copy and real par/1
...
CONST_4R	.REAL 3566.0
; CONST: $fehler in den datas!
CONST_5	.BYTE 20
.STRG "fehler in den datas!"
; CONST: #7
