...
LDA VAR_L%+1
JSR ARRAYSTORE_INT_INTEGER_AC
; Optimizer rule: Faster INT-Array-copy/10
; Optimized code for copying from int-array to int-array(1)
;
;
;
;
...
; Optimized code for copying from int-array to int-array(2)
;
;
;
;
...
; *** CONSTANTS ***
CONSTANTS
; CONST: $feld fuellen...{space*2}
CONST_0	.BYTE 24
.STRG "feld fuellen...{space*2}"
; CONST: #1
