0 rem expression:
1 x$="a*(b+e/(r+t^2)*11.2)+(12/t+3*2.1)*e+(e/(r+sin(t)*sin(a+cos(b+r))/e)*11.2)"
5 rem setup
10 gosub 1000:gosub 1100
20 gosub 1200:gosub 3000
30 rem run evaluator
40 gosub 2000
80 print "result: ";re:end
...
3401 :
3405 we=1*wm
3410 ifc$="*"orc$="/"thenwe=2*wm:goto 3430
3420 ifc$=chr$(94)thenwe=3*wm
...
3620 ifc$="("thenwm=10*wm
3630 ifc$=")"thenwm=wm/10
3640 return
3800 printc$:if(c$>="0"andc$<"9")orc$="."thennu$=nu$+c$:print"hhh",nu$:return
3810 print"syntax error in ";x$;" at position ";i;": ";c$:end
10000 rem push value to stack
10001 :
10010 sk(sp)=sv:sp=sp+1:printsv,sp:return
10100 rem get value from stack
10101 :
