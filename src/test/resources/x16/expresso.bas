...
90 COLOR 1,11:PRINT:PRINT "RESULT: ";RE:COLOR 1,6
100 GOTO 3900
...
3810 COLOR 1,2:PRINT:PRINT"SYNTAX ERROR IN ";X$;" AT POSITION ";I;": ";C$
3900 COLOR 1,6:PRINT:PRINT"PRESS ANY KEY!"
...
30000 REM
30010 :
30020 COLOR 1,6:PRINT CHR$(147):COLOR 0,12
