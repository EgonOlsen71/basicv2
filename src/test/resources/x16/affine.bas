100 REM
110 TI$="000000":DIM XD%(8):XD%(1)=0:XD%(0)=0:XD%(3)=6:XD%(2)=96
115 XD%(7)=2:XD%(6)=32:XD%(5)=1:XD%(4)=16
...
1370 XP=INT(X/2):CV=X-XP*2:CV=XD%(CV+2*PEEK(TX+(TP AND 4095)))
1380 PO=Y*320+XP:VPOKE 0, PO, VPEEK(0,PO) OR CV
1390 U=U+DU:V=V+DV
1400 NEXT X
...
20110 VPOKE 15,2,52:VPOKE 15,1,64:POKE 218,40:VPOKE15,$2000,0
20120 VPOKE 15,$3005,$0:VPOKE 15,$3001,$10:VPOKE 15,$3000,193
20130 RETURN
...
30000 P=0:FORY=0TO199:FORX=PTOP+160:VPOKE0,X,0:NEXT:P=P+320:NEXT
30010 RETURN