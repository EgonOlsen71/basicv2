0 IFPEEK($2AE)<>40THENSYS65375
1 POKE646,112:PRINT"{clear}":DIMS$(52):DIMC(52):M=20:D=0:CU=0
...
8 NEXTI,J
10 REM
11 PRINT"{home}{red}money{space*6}{left*6}";M;"p":GOSUB100
13 CU=CU+1
14 FORI=1TO4
