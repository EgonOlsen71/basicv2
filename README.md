...
In addition, it also offers a symbolic assembler that compiles assembler code in actual 6502 machine code. To execute these programs, it also comes with a 6502 emulation.
